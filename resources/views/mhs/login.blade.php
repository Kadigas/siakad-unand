        ...
        <div>
            ...
            <div class='card'>
                ...
                <form action="/mhs/signin" method='post' class='mx-8'>
                    @csrf
                    <label htmlFor="email" class='placeholder'>Student ID: </label>
                    <input type="email" name="email" value='{{Session::get('email')}}' placeholder="Enter your student ID..." size=54 class='mb-5 p-1'/>
